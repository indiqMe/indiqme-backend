...
using IndiqMe.Repository.Repository;
using System;
using System.Linq.Expressions;

namespace IndiqMe.Service.Generic
{
    public interface IBaseService<TEntity> where TEntity : class
    {
        ...
        /// <exception cref="IndiqMe.Domain.Exceptions.ShareBookException">In case that more than 1 entity could be returned for the filter specified.</exception>
